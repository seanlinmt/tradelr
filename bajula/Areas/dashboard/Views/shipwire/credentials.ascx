...
<h3><img src="/Content/img/social/icons/shipwire_32.png" /> Shipwire Credentials</h3>
<form id="passwordForm" action="/dashboard/shipwire/credentials" method="post">
<div class="info">Credentials are stored encrypted.</div>
<div class="form_entry">
    <div class="form_label">
        <label for="email">
            Shipwire Email</label>
    </div>
    <%= Html.TextBox("email") %>
</div>
<div class="form_entry">
