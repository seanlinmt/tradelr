...
namespace tradelr.Areas.dashboard.Models.orchard.filesystem.media {
    public class FileSystemStorageProvider : IStorageProvider {
        ...
        public FileSystemStorageProvider(string uniqueid) {
            _publicPath = string.Format("/Uploads/files/{0}/media", uniqueid);
            _storagePath = string.Format("{0}{1}", GeneralConstants.APP_ROOT_DIR, _publicPath);
        }
