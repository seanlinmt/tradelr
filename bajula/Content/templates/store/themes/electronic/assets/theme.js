...
if( $('.template-customers-addresses:first').length > 0 ){  
  ...
  new Tradelr.CountryProvinceSelector('address_country_new', 'address_province_new', {hideElement: 'address_province_container_new'});  
  ...
  $('.action-edit a').click( function(e){
    ...
    new Tradelr.CountryProvinceSelector(addressId, provinceId, {hideElement: provinceContainerId});   
