...
<body>
    <div id="container">
        ...
        <div class="banner_main">
            ...
            <h2 class="headingError">Trial Expired</h2>
            <p class="larger font_darkgrey">Your trial period has expired! You will not be able to create new products, invoices, purchase orders and contacts until you've <a href="/dashboard/account/plan">entered valid payment details</a>.</p>
            </div>
            </div>
        </div>
    </div>
